 ...
 * doubles. (0.0, 1.0, 2.0, etc.) Use any time you want a text field in which the user should enter
 * only integers.
 *
...
public class DoubleField extends JFormattedTextField {
  ...
  public static NumberFormatter getDoubleFormatter() {
    NumberFormatter doubleFormatter = new NumberFormatter(new DecimalFormat("#0.00"));
