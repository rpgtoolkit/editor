...
public final class ProjectMenu extends JMenu {
  ...
  public ProjectMenu() {
    ...
    configureAnimationMenuItem();
    configureBoardMenuItem();
    configureCharacterMenuItem();
    configureItemMenuItem();
    configureProgramMenuItem();
    configureSpecialMoveMenuItem();
    configureStatusEffectMenuItem();
    configureTileMenuItem();

    add(addAnimationMenuItem);
    add(addBoardMenuItem);
    add(addCharacterMenuItem);
    add(addItemMenuItem);
    add(addProgramMenuItem);
    add(addSpecialMoveMenuItem);
    add(addStatusEffectMenuItem);
    add(addTileMenuItem);
  }
