...
public abstract class AbstractSpriteModelPanel extends AbstractModelPanel {
  ...
  public AbstractSpriteModelPanel(AbstractSprite model) {
    ...
    baseVectorWidthSpinner.setModel(new SpinnerNumberModel(
            sprite.getBaseVector().getWidth(), 10, 100, 1));
    baseVectorWidthSpinner.addChangeListener(new ChangeListener() {
      ...
      public void stateChanged(ChangeEvent e) {
        ...
        // Assumes sprite base vector is rectangular in shape, will be a limitiation.
    ...
    baseVectorHeightSpinner.setModel(new SpinnerNumberModel(
            sprite.getBaseVector().getHeight(), 10, 100, 1));
    ...
    baseVectorOffsetXSpinner.setModel(new SpinnerNumberModel(
            sprite.getBaseVectorOffset().getX(), -1000, 1000, 1));
    ...
    baseVectorOffsetYSpinner.setModel(new SpinnerNumberModel(
            sprite.getBaseVectorOffset().getY(), -1000, 1000, 1));
    ...
    activationVectorWidthSpinner.setModel(new SpinnerNumberModel(
            sprite.getActivationVector().getWidth(), 10, 100, 1));
    ...
    activationVectorHeightSpinner.setModel(new SpinnerNumberModel(
            sprite.getActivationVector().getHeight(), 10, 100, 1));
    ...
    activationVectorOffsetXSpinner.setModel(new SpinnerNumberModel(
            sprite.getActivationVectorOffset().getX(), -1000, 1000, 1));
    ...
    activationVectorOffsetYSpinner.setModel(new SpinnerNumberModel(
            sprite.getActivationVectorOffset().getY(), -1000, 1000, 1));
