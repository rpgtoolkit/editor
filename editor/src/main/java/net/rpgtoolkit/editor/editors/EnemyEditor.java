...
public class EnemyEditor extends AbstractSpriteEditor implements InternalFrameListener {
  ...
  private void createStatsPanel() {
    ...
    experienceAwarded = new WholeNumberField(enemy.getExperienceAwarded());
    experienceAwarded.setColumns(DEFAULT_INPUT_COLUMNS);
    
    goldAwarded = new WholeNumberField(enemy.getGoldAwarded());
    ...
    profileImagePath = enemy.getProfilePicture();
...
//    this.goldAwarded = new WholeNumberField(this.enemy.getGoldAwarded());
//
