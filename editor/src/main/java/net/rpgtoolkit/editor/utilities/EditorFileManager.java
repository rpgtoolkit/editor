...
public class EditorFileManager {
    ...
    private static JFileChooser FILE_CHOOSER = new JFileChooser(CoreProperties.getProjectsDirectory());
     ...
     * projectEditor.setWindowParent(this); projectEditor.toFront();
     *
     * this.selectToolkitWindow(projectEditor); this.setTitle(this.getTitle() +
     * " - " + this.activeProject.getGameTitle());
     *
     * this.menuBar.enableMenus(true); this.toolBar.toggleButtonStates(true);
     * file of the given type, starting in the subdirectory for that type, and
     * return its location relative to the subdirectory for that type. Filters
     * by extensions relevant to that type. This is a shortcut method for
     ...
     * an invalid file is selected
     */
    public static File[] browseLocationBySubdirMultiSelect(String subdirectory, String description, String... extensions) {
